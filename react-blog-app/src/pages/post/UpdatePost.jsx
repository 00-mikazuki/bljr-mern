  ...
  const handleSubmit = async (e) => {
    ...
    if (errors.title || errors.category) {
      ...
      try {
        ...
        // API call to update post endpoint
        ...
        const response = error.response;
        const data = response?.data || {};
        const message = data.message || "An error occurred during post update";
      ...
      <div className="form-container">
        {loading ? <p>Loading...</p> : (
          <form className="inner-container" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <input className="button" type="submit" disabled={loading || isDisabled} value={loading ? "Updating..." : "Update"} />
            </div>
          </form>
        )}
      </div>
